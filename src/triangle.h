...
public:
    ...
    double perimeter() const override {
        ...
        {
            lengthC=(new TwoDimensionalVector(_v1->b(),_v2->b())) -> length();
        }
        else if(_v1->a()->operator==(*_v2->b())){
            lengthC=(new TwoDimensionalVector(_v1->b(),_v2->a())) -> length();
        }
        else if(_v1->b()->operator==(*_v2->a())){
            lengthC=(new TwoDimensionalVector(_v1->a(),_v2->b())) -> length();
        }
        else if(_v1->b()->operator==(*_v2->b())){
            lengthC=(new TwoDimensionalVector(_v1->a(),_v2->a())) -> length();
        }
