...
TEST_F(CollisionTest, TwoAdjacentRectanglesShouldCollide)
{
    ...
    delete rec1;delete p5;delete p6;delete p7;delete vec3;delete vec4; delete rec2;
}
...
TEST_F(CollisionTest, TwoAdjacentTrianglesShouldCollide)
{
    ...
    delete rec1;delete p5;delete p6;delete vec3;delete vec4; delete rec2;
}
...
TEST_F(CollisionTest, TwoAdjacentCirclesShouldCollide)
{
    ...
    delete cir1;delete p5;delete p6;delete cir2;delete vec3;
}
